...
//    private static double biasHO[] = new double[NUM_OUTPUT];
   ...
   // Constructor
    NN_backpropagation ( int activationType, int numInput, int numHidden, double learningRate, double momentum ) {
...
//        double activatedHidden[] = new double[numHidden];
    ...
    public static void main(String[] args) {
        NN_backpropagation bp = new NN_backpropagation ( 2, 2, 4, 0.2, 0.9 );
...
//                    System.out.println("activated   " + bp.activatedOutput);
                    ...
                    totalError += 0.5 * Math.pow( (bp.targetOutput[ i ] - bp.activatedOutput), 2 );
...
//                    System.out.println("epoch: " + epoch + "pattern no.: " + i + ", total error: " + totalError);
                ...
                //if(epoch % 10 == 0 ) {
                	...
                	filewriter.append(epoch + "," + totalError + "\n");
                //}
